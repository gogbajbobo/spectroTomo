...
axes[0, 0].imshow(filter_im_array(im_poly_0, sigma=2)[h_0_slice, :, :])
axes[0, 1].imshow(filter_im_array(im_alpha_0, sigma=2)[h_0_slice, :, :])
axes[0, 2].imshow(filter_im_array(im_beta_0, sigma=2)[h_0_slice, :, :])

axes[1, 0].imshow(filter_im_array(im_poly_1, sigma=2)[h_1_slice, :, :])
axes[1, 1].imshow(filter_im_array(im_alpha_1, sigma=2)[h_1_slice, :, :])
axes[1, 2].imshow(filter_im_array(im_beta_1, sigma=2)[h_1_slice, :, :])

plt.show()


# %%
# slices_y_0 = slice(45, 115)
# slices_x_0 = slice(40, 110)
slices_y_0 = slice(30, 110)
slices_x_0 = slice(30, 110)

im_poly_sliced_0 = im_poly_0[:, slices_y_0, slices_x_0]
im_alpha_sliced_0 = im_alpha_0[:, slices_y_0, slices_x_0]
im_beta_sliced_0 = im_beta_0[:, slices_y_0, slices_x_0]

# slices_z_1 = slice(70, 269)
# slices_y_1 = slice(20, 90)
# slices_x_1 = slice(35, 105)
slices_z_1 = slice(70, 301)
slices_y_1 = slice(30, 110)
slices_x_1 = slice(30, 110)

im_poly_sliced_1 = im_poly_1[slices_z_1, slices_y_1, slices_x_1]
im_alpha_sliced_1 = im_alpha_1[slices_z_1, slices_y_1, slices_x_1]
im_beta_sliced_1 = im_beta_1[slices_z_1, slices_y_1, slices_x_1]
...
# axes[0].imshow(im_poly_0[145, 45:115, 40:110])
# axes[1].imshow(im_poly_1[215, 20:90, 35:105])


# %%
sigma = 2

im_poly_gf_0 = filter_im_array(im_poly_sliced_0, sigma=sigma)
im_alpha_gf_0 = filter_im_array(im_alpha_sliced_0, sigma=sigma)
im_beta_gf_0 = filter_im_array(im_beta_sliced_0, sigma=sigma)

im_poly_gf_1 = filter_im_array(im_poly_sliced_1, sigma=sigma)
im_alpha_gf_1 = filter_im_array(im_alpha_sliced_1, sigma=sigma)
im_beta_gf_1 = filter_im_array(im_beta_sliced_1, sigma=sigma)
...
# %%
rnd_indx = np.random.choice(range(im_alpha_gf_1.size), size=10000, replace=False)
